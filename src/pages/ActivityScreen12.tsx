...
import styles from "./ActivityScreen12.module.css";

const ActivityScreen12: FunctionComponent = () => {
        ...
        <div className={styles.frameParent}>
          <div className={styles.cardParent}>
            <div className={styles.card}>
              ...
              <div className={styles.heartCardsParent}>
                <img className={styles.heartCardsIcon} alt="" src="/card.svg" />
          ...
          <div className={styles.cardGroup}>
            <div className={styles.card2} onClick={onCardContainerClick}>
              ...
              <div className={styles.cardComponentsParent}>
                <img
                  className={styles.cardComponentsIcon}
                  alt=""
                  src="/card.svg"
                />
...
export default ActivityScreen12;
